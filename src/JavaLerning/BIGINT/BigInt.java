...
public class BigInt {
    ...
    public String add(BigInt other) {
    ...
    public String subtract(BigInt other) {
        List<Integer> result = new ArrayList<>();
        int maxLength = Math.max(this.number.size(), other.number.size());
        int borrow = 0;
    ...
    public String multiply(BigInt other) {
    ...
    public String[] divide(BigInt other) {
    ...
    public static void main(String[] args) {
        BigInt num1 = new BigInt("0012345678901234567890");
